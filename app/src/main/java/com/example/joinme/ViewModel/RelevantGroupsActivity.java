...
public class RelevantGroupsActivity extends AppCompatActivity implements RecycleViewInterface {
    ...
    public void onDetailsClick(int position) {
        ...
        intent.putExtra("from", "RelevantGroups");
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.code() == 200) {
                    ...
                    Intent intent = new Intent(RelevantGroupsActivity.this, GroupSuggestionActivity.class);
                    String title = contacts.get(position).getCategory();
